...
export function PostCard({ 
  ...
  return (
    <article
      ...
      className={`rounded-xl p-4 md:p-5 shadow-card-subtle border border-[var(--b1)] bg-[var(--card)] text-[var(--t1)] shrink-0 transition-colors duration-300 relative select-none`}
    >
      {copiedShare && (
